...
const Add = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await axiosPrivate.post('/Colors/Add', addItem, config);
    ...
    <>
      ...
      >
        ...
        <input
          ...
          placeholder=""
          autoFocus
          {...register('colorName', { required: 'This field is required' })}
        />
        {errors.colorName && (
