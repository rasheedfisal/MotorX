...
const Add = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const addItem = {
        specsName: data.specsName,
        specsNameAr: data.specsNameAr
      };
      const config = {
        headers: {
      ...
      const response = await axiosPrivate.post('/Specs/Add', addItem, config);
    ...
    <>
      ...
      >
        ...
        <input
          ...
          placeholder=""
          autoFocus
          {...register('specsName', { required: 'This field is required' })}
        />
        {errors.specsName && (
          <div className="mb-3 text-normal text-red-500">
            {errors.specsName.message}
          </div>
        )}
        ...
        <input
          ...
          type="text"
          placeholder=""
          {...register('specsNameAr', { required: 'This field is required' })}
        />
        {errors.specsNameAr && (
          <div className="mb-3 text-normal text-red-500 ">
            {errors.specsNameAr.message}
          </div>
        )}
