  ...
  const onSubmit = async (data) => {
    ...
    try {
      const addItem = {
        ...
        gearboxNameAr: data.gearboxNameAr
      };
      const config = {
        headers: {
      ...
      const response = await axiosPrivate.post('/Gearbox/Add', addItem, config);
    ...
    <>
      ...
      >
        ...
        <input
          ...
          placeholder=""
          autoFocus
          {...register('gearboxName', { required: 'This field is required' })}
        />
        {errors.gearboxName && (
          <div className="mb-3 text-normal text-red-500">
            {errors.gearboxName.message}
          </div>
        )}
        ...
        <input
          ...
          type="text"
          placeholder=""
          {...register('gearboxNameAr', { required: 'This field is required' })}
        />
        {errors.gearboxNameAr && (
          <div className="mb-3 text-normal text-red-500 ">
            {errors.gearboxNameAr.message}
          </div>
        )}
