...
const Manage = () => {
  ...
  const ReadFeatures = async () => {
    ...
    try {
      setLoading(true);
      const response = await axiosPrivate.get('/Features/GetAll', {
  ...
  const Update = (id) => {
    navigate('/Features/Update', { state: { id } });
  };
                    ...
                    {list.map((ft) => (
                      <tr key={ft.id}>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-500">{ft.id}</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <div className="text-sm font-medium text-gray-900">
                            <p>
                              {' '}
                              {ft.featureName} - {ft.featureNameAr} [
                              {ft.featuresType.typeName}]
                            </p>
                          </div>
                          {/* </div> */}
                        </td>
