...
const Manage = () => {
  ...
  const ReadItems = async () => {
    ...
    try {
      setLoading(true);
      const response = await axiosPrivate.get('/CarType/GetAll', {
  ...
  const Update = (id) => {
    navigate('/Category/Update', { state: { id } });
  };
